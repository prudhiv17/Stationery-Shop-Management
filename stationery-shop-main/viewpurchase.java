...
public class viewpurchase extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        billdisp = new javax.swing.JTable();
        ...
        billdisp.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Purchase ID", "Product ID", "Quantity", "Total"
            }
        ));
        jScrollPane1.setViewportView(billdisp);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            while(rs.next()){
               ...
               DefaultTableModel model = (DefaultTableModel)billdisp.getModel();
               model.addRow(table);
                }
                }
                catch(Exception e){
    ...
    private javax.swing.JTable billdisp;
